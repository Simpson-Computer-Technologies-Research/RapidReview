          ...
          body: ListView(physics: const BouncingScrollPhysics(), children: [
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                              onTap: () async {
                                !isVisible
                                    ? {controller.fadeIn(), isVisible = true}
                                    : {controller.fadeOut(), isVisible = false};
                              },
            ...
            Padding(
                ...
                child: GridView.builder(
                    ...
                    physics: const BouncingScrollPhysics(),
                    gridDelegate:
                        const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio: 3 / 2),
                    itemCount: profilePictures.length,
                    itemBuilder: (BuildContext context, int index) =>
                        FutureBuilder<Map>(
                                ...
                                return GestureDetector(
                                    onTap: () async {
                                      Navigator.push(context, 
                                        PageRouteBuilder(pageBuilder: (_, __, ___) => RequestsPage(index: index))
                                      );
                                    },
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                            color: !snapshot.hasError
                                                ? Cache.rgbConvert(snapshot.data!["profile_image_colors"][profilePictures[index]])
                                                : Colors.white,
